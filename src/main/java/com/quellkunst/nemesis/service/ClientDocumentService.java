...
public class ClientDocumentService {
  ...
  @Inject ClientDocumentRepository clientDocumentRepository;
  ...
  public Response get(@PathParam long id) {
    ClientDocument document = clientDocumentRepository.byId(id);
  ...
  public Response delete(@PathParam long id) {
    ClientDocument entity = clientDocumentRepository.byId(id);
